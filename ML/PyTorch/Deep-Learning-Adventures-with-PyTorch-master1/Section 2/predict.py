#Classify images using a pre trained AlexNet CNN network ---------(working from 1st time)
...
def get_imgnet_classes():
    ...
    """
    #Here can be a problem if run using IDE (ide may run file from different directory)
...
# NICE ! using 2 networks (pretrained and custom!!!)
if __name__ ==  '__main__':
    print("\033[91mClassification using pretrained AlexNet CNN model:\033[0m")
