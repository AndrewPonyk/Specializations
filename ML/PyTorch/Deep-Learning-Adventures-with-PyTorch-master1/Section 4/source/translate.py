...
def dummy(*args, **kwargs):
    """ This is the place where all the messages got lost... """
    pass

if  __name__ == '__main__':
    # We could save both input_lang and output_lang on training so we didn't have to load data from scratch.
